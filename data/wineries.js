...
const washingtonWineries = [
    ...
    },
    {
        ...
        name: 'Quilceda Creek Vintners',
        region: 'Snohomish',
        coords: [47.8587, -122.0652],
        specialty: 'Cabernet Sauvignon, Merlot',
        description: 'Washington\'s first 100-point wine producer, known for exceptional Bordeaux-style blends and cult status.',
        suitedFor: ['expert', 'professional'],
        wineTypes: ['reds'],
        priceLevel: 'luxury',
        tastingFee: 75,
        ...
        phone: '(425) 483-9463',
        website: 'https://www.quilcedacreek.com',
        features: ['Cult wines', 'By appointment', 'Limited production', '100-point wines'],
        rating: 4.9
    },
    {
        id: 14,
        ...
        coords: [46.0646, -118.3430],
        specialty: 'Syrah, Grenache, Tempranillo',
        description: 'Biodynamic pioneer producing terroir-driven wines with French winemaking techniques.',
        suitedFor: ['expert', 'professional'],
        wineTypes: ['reds'],
        priceLevel: 'luxury',
        tastingFee: 60,
        ...
        phone: '(509) 526-0686',
        website: 'https://www.cayusevineyards.com',
        features: ['Biodynamic', 'French techniques', 'By appointment', 'Terroir-focused'],
        rating: 4.8
    },
    {
        id: 15,
        ...
        region: 'Walla Walla',
        coords: [46.0646, -118.3430],
        specialty: 'Syrah, Viognier, Grenache',
        description: 'Rockstar winemaker Charles Smith\'s premium label with bold, expressive wines.',
        suitedFor: ['intermediate', 'expert'],
        wineTypes: ['reds', 'whites'],
        priceLevel: 'premium',
        tastingFee: 45,
        hours: '11:00 AM - 5:00 PM',
        phone: '(509) 526-5230',
        website: 'https://www.kvintners.com',
        features: ['Rockstar winemaker', 'Bold wines', 'Modern style'],
        rating: 4.6
    },
    {
        id: 16,
        ...
        region: 'Walla Walla',
        coords: [46.0646, -118.3430],
        specialty: 'Syrah, Tempranillo, Cabernet Sauvignon',
        description: 'Artisanal winery focusing on Spanish and Rhône varietals with minimal intervention.',
        suitedFor: ['intermediate', 'expert'],
        wineTypes: ['reds'],
        priceLevel: 'premium',
        tastingFee: 40,
        ...
        phone: '(509) 876-2427',
        website: 'https://www.gramercycellars.com',
        features: ['Spanish varietals', 'Minimal intervention', 'Artisanal'],
        rating: 4.5
    },
    {
        id: 17,
        name: 'Woodinville Wine Cellars',
        region: 'Woodinville',
        coords: [47.7511, -122.1173],
        specialty: 'Chardonnay, Pinot Noir, Cabernet Sauvignon',
        description: 'Family-owned winery producing approachable wines with excellent value and friendly atmosphere.',
        suitedFor: ['beginner', 'intermediate'],
        wineTypes: ['reds', 'whites'],
        priceLevel: 'moderate',
        tastingFee: 25,
        ...
        phone: '(425) 481-8860',
        website: 'https://www.woodinvillewinecellars.com',
        features: ['Family-owned', 'Great value', 'Friendly atmosphere'],
        rating: 4.3
    },
    {
        id: 18,
        name: 'Sparkman Cellars',
        region: 'Woodinville',
        coords: [47.7511, -122.1173],
        specialty: 'Cabernet Sauvignon, Riesling, Syrah',
        description: 'Passionate winemaking with focus on terroir expression and sustainable practices.',
        suitedFor: ['intermediate', 'expert'],
        wineTypes: ['reds', 'whites'],
        priceLevel: 'premium',
        tastingFee: 35,
        hours: '12:00 PM - 6:00 PM',
        phone: '(425) 398-1045',
        website: 'https://www.sparkmancellars.com',
        features: ['Sustainable', 'Terroir-focused', 'Passionate winemaking'],
        rating: 4.4
    },
    {
        id: 19,
        ...
        region: 'Woodinville',
        coords: [47.7511, -122.1173],
        specialty: 'Riesling, Chardonnay, Cabernet Sauvignon',
        description: 'Modern winery known for exceptional white wines and innovative winemaking techniques.',
        suitedFor: ['intermediate', 'expert'],
        wineTypes: ['whites', 'reds'],
        priceLevel: 'premium',
        tastingFee: 40,
        hours: '12:00 PM - 6:00 PM',
        phone: '(425) 398-7200',
        website: 'https://www.efeste.com',
        features: ['White wine specialist', 'Innovation', 'Modern techniques'],
        rating: 4.6
    },
    {
        id: 20,
        name: 'Novelty Hill Vintners',
        region: 'Woodinville',
        coords: [47.7511, -122.1173],
        specialty: 'Cabernet Sauvignon, Chardonnay, Syrah',
        description: 'Elegant wines from estate vineyards with beautiful tasting room and vineyard views.',
        suitedFor: ['intermediate', 'expert'],
        wineTypes: ['reds', 'whites'],
        priceLevel: 'premium',
        tastingFee: 35,
        hours: '11:00 AM - 5:00 PM',
        phone: '(425) 481-8400',
        website: 'https://www.noveltyhillvintners.com',
        features: ['Estate vineyards', 'Elegant wines', 'Beautiful views'],
        rating: 4.5
    },
    {
        id: 21,
        ...
        region: 'Woodinville',
        coords: [47.7511, -122.1173],
        specialty: 'Bordeaux blends, Chardonnay',
        description: 'Pioneer of Washington Bordeaux-style wines with consistent quality and French inspiration.',
        suitedFor: ['intermediate', 'expert'],
        wineTypes: ['reds', 'whites'],
        priceLevel: 'premium',
        tastingFee: 40,
        ...
        features: ['Bordeaux specialist', 'French inspiration', 'Consistent quality'],
        rating: 4.6
    },
    {
        id: 22,
        ...
        coords: [46.0646, -118.3430],
        specialty: 'Cabernet Sauvignon, Syrah, Chardonnay',
        description: 'Family winery in converted airplane hangar producing bold, food-friendly wines.',
        suitedFor: ['beginner', 'intermediate'],
        wineTypes: ['reds', 'whites'],
        priceLevel: 'moderate',
        tastingFee: 30,
        ...
        features: ['Airplane hangar', 'Family-owned', 'Food-friendly'],
        rating: 4.4
    },
    {
        id: 23,
        ...
        region: 'Walla Walla',
        coords: [46.0646, -118.3430],
        specialty: 'Barbera, Sangiovese, Cabernet Sauvignon',
        description: 'Italian varietals specialist with rustic charm and authentic winemaking traditions.',
        suitedFor: ['intermediate', 'expert'],
        wineTypes: ['reds'],
        priceLevel: 'moderate',
        tastingFee: 35,
        ...
        phone: '(509) 522-9463',
        website: 'https://www.forgeroncellars.com',
        features: ['Italian varietals', 'Rustic charm', 'Traditional methods'],
        rating: 4.3
    },
    {
        id: 24,
        name: 'Betz Family Winery',
        region: 'Woodinville',
        coords: [47.7511, -122.1173],
        specialty: 'Syrah, Cabernet Sauvignon, Grenache',
        description: 'Small production winery creating Rhône and Bordeaux-style wines with Burgundian philosophy.',
        suitedFor: ['expert', 'professional'],
        wineTypes: ['reds'],
        priceLevel: 'luxury',
        tastingFee: 50,
        hours: 'By appointment only',
        phone: '(425) 861-9823',
        website: 'https://www.betzfamilywinery.com',
        features: ['Small production', 'Burgundian philosophy', 'By appointment'],
        rating: 4.7
    },
    {
        id: 25,
        ...
        specialty: 'Pinot Noir, Chardonnay, Syrah',
        description: 'Pacific Northwest pioneer with multiple locations focusing on terroir-driven wines.',
        suitedFor: ['intermediate', 'expert'],
        wineTypes: ['reds', 'whites'],
        priceLevel: 'moderate',
        tastingFee: 25,
        ...
        features: ['Multiple locations', 'Terroir-driven', 'Pioneer status'],
        rating: 4.4
    },
    {
        id: 26,
        name: 'Hedges Family Estate',
        region: 'Red Mountain',
        coords: [46.2755, -119.4683],
        specialty: 'Cabernet Sauvignon, Merlot, Syrah',
        description: 'Sustainable estate winery on Red Mountain with spectacular views and Bordeaux varietals.',
        suitedFor: ['intermediate', 'expert'],
        wineTypes: ['reds'],
        priceLevel: 'premium',
        tastingFee: 35,
        ...
        phone: '(509) 786-2535',
        website: 'https://www.hedgesfamilyestate.com',
        features: ['Sustainable', 'Red Mountain', 'Spectacular views', 'Estate grown'],
        rating: 4.5
    },
    {
        id: 27,
        name: 'Matthews Estate',
        region: 'Woodinville',
        coords: [47.7511, -122.1173],
        specialty: 'Cabernet Sauvignon, Merlot, Syrah',
        description: 'Boutique winery focusing on single-vineyard Bordeaux and Rhône varietals with elegant style.',
        suitedFor: ['intermediate', 'expert'],
        wineTypes: ['reds'],
        priceLevel: 'premium',
        tastingFee: 40,
        hours: '12:00 PM - 6:00 PM',
        phone: '(425) 487-9810',
        website: 'https://www.matthewsestate.com',
        features: ['Single-vineyard', 'Elegant style', 'Boutique'],
        rating: 4.6
    }
];
